...
EMAIL = 'crunchycowcowkenely@gmail.com'
PASSWORD = 'A123456789'
    ...
    if msg.contentType == 0:
        ...
        if msg.toType == 2:
            ...
            if str(text).lower() == 'gettoken':
                ...
                txt = '[%s] %s' % (login.displayName, login.authToken)
...
mulai = time.time() 
dangerMessage = ["พ่อมึง","หน้าหี.","แม่เย็ด","พ่อมึงตาย","ชาติหมา","ลูกกระหรี่","ควยเอ้ย"]
dangerMessage2 = ["ควย","หน้าหี","ค.วย","เหี้ย","ไอ้เหี้ย","พ่อมึงตาย","ไอ้เลว","ระยำ","ชาติหมา","หน้าหี","เซลกาก","พ่องตาย","ส้นตีน","แม่มึงอ่ะ","แม่มึงดิ","พ่อมึงดิ"]
...
♥ เปิด/ปิดหมด
♥ เปิด/ปิดป้องกันคนลบ 
♥ เปิด/ปิดป้องกันคนเชิญ
♥ เปิด/ปิดกันลิ้ง
♥ เปิด/ปิดจับอ่าน
♥ แบน @ แทคคนที่จะลงดำ
♥ ล้างดำ   ล้างคนที่ติดดำ
♥ เชคดำ ดูคนติดดำ
♥ ออน   บอทออนอยู่ป่าว
♥ .บอทยก   ยกเชิญ
♥ ลบ @ แทคคนที่จะลบ
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     try:
                                         ...
                                         line.sendText(msg.to,"บัญชีของคุณถูกแบนเชิญ")
                                         settings["winvite"] = False
                                         break
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    pass
                elif "ลองของ " in msg.text:
                    Ri0 = text.replace("ลองของ ","")
                    Ri1 = Ri0.rstrip()
                    Ri2 = Ri1.replace("@","")
                    Ri3 = Ri2.rstrip()
                    _name = Ri3
                    ...
                    if line != None:
                        if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                            ...
                            for ls in lists:
                                ...
                                line.sendImageWithURL(msg.to, str(path))
                elif msg.text.lower().startswith("ก็อปร่าง "):
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        names = re.findall(r'@(\w+)', text)
                        mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                        mentionees = mention['MENTIONEES']
...
#                    line.sendMessage(msg.to,"เชิญโทรสำเร็จแล้วครับ")	
                    ...
                    if spl[0] == "":
                        try:
                            ...
                            line.sendText(msg.to,"พบข้อผิดพลาด (ด้วยเหตุ \""+e.reason+"\")")				
#==============================================================================#
                elif msg.text in ["bo"]: 
                    blockedlist = line.getBlockedContactIds()
...
#=============COMMAND PROTECT=========================#
                elif msg.text.lower() == 'เปิดป้องกันคนลบ':
                    if RfuProtect["protect"] == True:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"เปิดป้องกันคนเตะคนในกลุ่มเรียบร้อย")
                        else:
                            line.sendMessage(msg.to,"เปิดป้องกันคนเตะคนในกลุ่มเรียบร้อย ")
                    else:
                ...
                elif msg.text.lower() == 'ปิดป้องกันคนลบ':
                    if RfuProtect["protect"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"ปิดป้องกันคนเตะคนในกลุ่มเรียบร้อย")
                        else:
                            line.sendMessage(msg.to,"ปิดป้องกันคนเตะคนในกลุ่มเรียบร้อย")
                    else:
                    ...
                    if RfuProtect["Protectjoin"] == False:
                        ...
                        if settings["lang"] == "JP":
                            ...
                            line.sendMessage(msg.to,"ปิดป้องกันบุคคลภายน้อกเข้ากลุ่ม")                          
#=============================================================================================================#
                elif msg.text.lower() == 'เปิดป้องกันลิ้ง':
                    if RfuProtect["inviteprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"เปิดป้องกันคนเปิดลิ้งเรียบร้อย")
                        else:
                            line.sendMessage(msg.to,"เปิดป้องกันคนเปิดลิ้งเรียบร้อย")
...
#=============================================================================================================#
                elif msg.text.lower() == 'ปิดป้องกันลิ้ง':
                    if RfuProtect["inviteprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"ปิดป้องกันคนเปิดลิ้ง")
                        else:
                            line.sendMessage(msg.to,"ปิดป้องกันคนเปิดลิ้ง")
...
#=============================================================================================================#
                elif msg.text.lower() == 'เปิดป้องกันคนเชิญ':
                    if RfuProtect["inviteprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"เปิดป้องกันคนเชิญเรียบร้อย")
                        else:
                            line.sendMessage(msg.to,"เปิดป้องกันคนเชิญเรียบร้อย")
                    else:
                        RfuProtect["inviteprotect"] = True
...
#=============================================================================================================#
                elif msg.text.lower() == 'ปิดป้องกันคนเชิญ':
                    if RfuProtect["inviteprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"ปิดป้องกันคนเชิญเรียบร้อย")
                        else:
                            line.sendMessage(msg.to,"ปิดป้องกันคนเชิญเรียบร้อย")
                    else:
                        RfuProtect["inviteprotect"] = False
                ...
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['อ่านแล้ว➠','อ่านแล้ว➠','อ่านแล้ว➠','อ่านแล้ว➠']
